...
{
    public static $allowedSpeed = [10 => 100, 9 => 90, 8 => 80, 7 => 70, 6 => 60, 5 => 50, 4 => 40, 3 => 30, 2 => 20, 1 => 10];
    ...
    public static function GetAvailableMissions($USER, $MissionInfo, $GetInfoPlanet)
    {
        ...
        {
            if ((isset($MissionInfo['Ship'][209]) || isset($MissionInfo['Ship'][219])) && isModuleAvailable(MODULE_MISSION_RECYCLE) && !($GetInfoPlanet['debris_metal'] == 0 && $GetInfoPlanet['debris_crystal'] == 0))
            {
                $availableMissions[] = 8;
            }
        }
