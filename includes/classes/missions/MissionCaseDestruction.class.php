...
HTML;
        ...
        $fleetIntoDebris = Config::get($this->_fleet['fleet_universe'])->debris_percentage_fleet;
        $defIntoDebris = Config::get($this->_fleet['fleet_universe'])->debris_percentage_defense;
