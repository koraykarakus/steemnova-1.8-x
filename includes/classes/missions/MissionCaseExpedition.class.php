...
class MissionCaseExpedition extends MissionFunctions implements Mission
{
    ...
    public function EndStayEvent()
    {
        ...
        do
        {
            ...
            elseif ($GetEvent < 415)
            {
                ...
                if (!$config->expedition_allow_darkmatter_find)
                {
                    break;
                }
            ...
            elseif ($GetEvent < 635)
            {
                ...
                if (!$config->expedition_allow_ships_find)
                {
                    break;
                }
            ...
            elseif ($GetEvent < 719)
            {
                ...
                if (!$config->expedition_allow_expedition_war)
                {
                    break;
                }
	...
	HTML;
                ...
                $combatResult = calculateAttack($fleetAttack, $fleetDefend, $config->debris_percentage_fleet, $config->debris_percentage_defense);
            ...
            elseif ($GetEvent < 722)
            {
                ...
                if (!$config->expedition_allow_fleet_loss)
                {
                    break;
                }
            ...
            elseif ($GetEvent < 812)
            {
                ...
                if ($chance < 75)
                {
                    if (!$config->expedition_allow_fleet_delay)
                    {
                        break;
                    }
                    // More return time
                ...
                {
                    if (!$config->expedition_allow_fleet_speedup)
                    {
                        break;
                    }
                    // Less return time
