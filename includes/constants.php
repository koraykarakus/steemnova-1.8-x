...
define('MODULE_FORUM', 45);
define('MODULE_MISSION_TRANSFER', 46);
define('MODULE_SERVER_INFO', 47);
define('MODULE_ATTACK_ALERT', 48);
define('MODULE_RELOCATE', 49);
define('MODULE_AUTOEXPEDITION', 50);
define('MODULE_COLLECT_MINES', 51);
define('MODULE_FLIGHT_SIMULATOR', 52);
define('MODULE_CHANGELOG', 53);
define('MODULE_LOGIN_NEWS', 54);
define('MODULE_LOGIN_SCREENSHOTS', 55);
define('MODULE_LOGIN_BANLIST', 56);
define('MODULE_LOGIN_BATTLEHALL', 57);
define('MODULE_LOGIN_DISCLAIMER', 58);
define('MODULE_AUTH_GOOGLE', 59);
define('MODULE_AUTH_DISCORD', 60);
define('MODULE_QUESTIONS', 61);
define('MODULE_PLANET_SELECTOR', 62);
define('MODULE_FIND_DEBRIS', 63);
define('MODULE_MARKET_PLACE', 64);
define('MODULE_AMOUNT', 65);
