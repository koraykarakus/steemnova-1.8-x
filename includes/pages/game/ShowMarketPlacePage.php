...
{
    public static int $require_module = MODULE_BATTLEHALL;
    ...
    private function doBuy(): string
    {
        ...
        $Distance = FleetFunctions::GetTargetDistance([$PLANET['galaxy'], $PLANET['system'], $PLANET['planet']], [$fleetResult['fleet_end_galaxy'], $fleetResult['fleet_end_system'], $fleetResult['fleet_end_planet']]);
        ...
        $Message = sprintf(
            ...
            $fleetResult['fleet_start_galaxy'].":".$fleetResult['fleet_start_system'].":".$fleetResult['fleet_start_planet'],
            $fleetResource[901],
            $LNG['tech'][901],
            $fleetResource[902],
            $LNG['tech'][902],
    ...
    public function show(): void
    {
        ...
        foreach ($fleetResult as $fleetsRow)
        {
            ...
            $FROM_Distance = FleetFunctions::GetTargetDistance([$PLANET['galaxy'], $PLANET['system'], $PLANET['planet']], [$fleetsRow['fleet_end_galaxy'], $fleetsRow['fleet_end_system'], $fleetsRow['fleet_end_planet']]);
            ...
            //TO
            $TO_Distance = FleetFunctions::GetTargetDistance([$PLANET['galaxy'], $PLANET['system'], $PLANET['planet']], [$fleetsRow['fleet_start_galaxy'], $fleetsRow['fleet_start_system'], $fleetsRow['fleet_start_planet']]);
