...
{
    public static int $require_module = MODULE_SIMULATOR;
    ...
    public function show(): void
    {
        ...
        if (empty($_REQUEST['battle_input']))
        {
            ...
            {
                if (FleetFunctions::GetFleetMaxSpeedByID($id, $USER) > 0)
                {
