...
function ShowAccountDataPage()
{
    ...
    if (!empty($id_u))
    {
        ...
        $OnlyQueryLogin = Database::get()->selectSingle($sql, [
            ':userId'   => $id_u,
            ':universe' => Universe::getEmulated(),
        ]);
        ...
        else
        {
            ...
            $UserQuery = Database::get()->selectSingle($sql, [
                ':userId' => $id_u,
            ]);
            ...
            if ($UserQuery['bana'] != 0)
            {
                ...
                $BannedQuery = Database::get()->selectSingle($sql, [
            ...
            $StatQuery = Database::get()->selectSingle($sql, [
                ':userId' => $id_u,
            ]);
            ...
            elseif ($alianza != null && $AliID != 0)
            {
                ...
                $AllianceQuery = Database::get()->selectSingle($sql, [
                    ':ally_name' => $alianza,
                ]);
                ...
                $SearchLeader = Database::get()->selectSingle($sql, [
                ...
                $StatQueryAlly = Database::get()->selectSingle($sql, [
                    ':ally_leader' => $ali_lider,
                ]);
            ...
            $PlanetsQuery = Database::get()->select($sql, [
                ':userId' => $id_u,
            ]);
