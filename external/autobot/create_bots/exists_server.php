...
while ($created != 1)
{
    ...
    if (empty($is_empty))
    {
        ...
        mysqli_query($connection, "UPDATE uni1_planets SET rocket_launcher=$user_planets[39] WHERE id=$id");
        mysqli_query($connection, "UPDATE uni1_planets SET light_laser=$user_planets[40] WHERE id=$id");
        mysqli_query($connection, "UPDATE uni1_planets SET heavy_laser=$user_planets[41] WHERE id=$id");
        mysqli_query($connection, "UPDATE uni1_planets SET gauss_cannon=$user_planets[42] WHERE id=$id");
        mysqli_query($connection, "UPDATE uni1_planets SET ion_cannon=$user_planets[43] WHERE id=$id");
        mysqli_query($connection, "UPDATE uni1_planets SET plasma_turret=$user_planets[44] WHERE id=$id");
        ...
        mysqli_query($connection, "UPDATE uni1_planets SET graviton_cannon=$user_planets[48] WHERE id=$id");
