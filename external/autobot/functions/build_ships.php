...
for ($j = 0;$j <= count($bots) - 1;$j++)
{
    ...
    foreach ($planets as $bot_planet)
    {
        ...
        if (!isset($id))
        {
            ...
            elseif (($id_bot % 2 == 0) && ($metal >= 5000000) && ($crystal >= 4000000) && ($deuterium >= 1000000))
            {
