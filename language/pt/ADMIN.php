...
$LNG['rf_title'] = "Configurações RapidFire";
$LNG['rf_rapidfire_rules'] = "Regras Rapidfire";
$LNG['rf_add_new_rapidfire_rule'] = "Adicionar nova regra rapidfire";
$LNG['rf_turn_back_to_default'] = "Voltar às configurações padrão";
$LNG['rf_against'] = "Contra";
$LNG['rf_shoots'] = "Dispara";
$LNG['rf_action'] = "Ação";
$LNG['rf_modify'] = "Modificar";
$LNG['rf_add_new_rule'] = "Adicionar nova regra";
$LNG['rf_from'] = "De";
$LNG['rf_to'] = "Para";
$LNG['rf_shoots'] = "Dispara";
$LNG['rf_save'] = "Salvar";
$LNG['rf_err_update_1'] = "Entradas vazias ou element_id incorreto";
$LNG['rf_err_remove_1'] = "Entrada incorreta";
$LNG['rf_err_add_1'] = "Dados do formulário ausentes, verifique as entradas";
$LNG['rf_err_add_2'] = "Esta regra já existe, modifique se quiser alterar";
$LNG['rf_suc_add'] = "Adicionado com sucesso";

// ShowGameSettingsPage, buildings settings
$LNG['gsb_title'] = "Configurações de Edifícios";
$LNG['gsb_settings'] = "Configurações";
$LNG['gsb_add_new_building'] = "Adicionar Novo Edifício";
$LNG['gsb_default_settings'] = "Configurações Padrão [edifícios]";
$LNG['gsb_cost_grow_factor'] = "fator de crescimento do custo";
$LNG['gsb_base_cost_metal'] = "custo base metal";
$LNG['gsb_base_cost_crystal'] = "custo base cristal";
$LNG['gsb_base_cost_deu'] = "custo base deutério";
$LNG['gsb_base_cost_energy'] = "custo base energia";
$LNG['gsb_base_cost_dm'] = "custo base DM";
$LNG['gsb_modify'] = "Modificar";

// google auth
$LNG['google_auth_settings'] = "Configurações de conexão do Google Auth";
$LNG['google_auth_info'] = "Este recurso pode ser ativado/desativado na página de Módulos.\n
Cadastre-se no console da Google API e obtenha seus IDs de cliente e segredo no Google.\n
Configure corretamente sua URL de callback no console da Google API,\n a página deve ser sempre googleAuth e o modo deve ser sempre callback.\n
As URLs de callback do console da API devem corresponder à URL de callback deste formulário.\n
Use https se você tiver SSL.";
$LNG['google_auth_client_id'] = "ID do cliente:";
...
$LNG['cs_rocket_launcher_start'] = "Lançador de mísseis (quantidade)";
$LNG['cs_light_laser_start'] = "Laser pequeno (quantidade)";
$LNG['cs_heavy_laser_start'] = "Laser grande (quantidade)";
$LNG['cs_gauss_cannon_start'] = "Canhão Gauss (quantidade)";
$LNG['cs_ion_cannon_start'] = "Canhão iônico (quantidade)";
$LNG['cs_plasma_turret_start'] = "Canhão Buster (quantidade)";
...
$LNG['ad_editor_officers'] = 'Oficiais';
...
//---------------	Pagina Inicial	------------------------//
$LNG['ow_title'] = 'Steemnova 1.8 X - Jogo de estratégia espacial';
$LNG['ow_donate'] = 'Doar';
...
$LNG['se_expedition_speed'] = 'Velocidade de expedição';
$LNG['se_forum_link'] = 'Link de Forum';
$LNG['se_server_op_close'] = 'O jogo está fechado?';
...
$LNG['se_planets_officers'] = 'Numero máximo de colonias com oficiais';
$LNG['se_planets_officers_info'] = 'Por nivel de algum oficial, numero máximo de colonias com estes';
...
$LNG['mu_improved_game_settings'] = "Configurações de jogo aprimoradas";
...
$LNG['mu_verify'] = 'Verificar Conteúdo do Jogo';
...
$LNG['ac_officers_research'] = 'Pesquisa';
...
$LNG['ac_urlnow'] = 'URL: ';
$LNG['ac_time_destroyed'] = 'Data de destruição total';
$LNG['ac_is_not_destroyed'] = '<font color=red>(Não existe qualquer planeta destruido recentemente)</font>';
...
$LNG['qe_debris'] = "Destroços";
$LNG['qe_err_planet_not_found'] = "Planeta não encontrada, ID do planeta incorreto.";
$LNG['qe_err_user_not_found'] = "O planeta (ID: %s) não pertence a nenhum usuário, considere removê-lo do banco de dados.";
