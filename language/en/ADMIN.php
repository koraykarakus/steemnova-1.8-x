...
$LNG['cs_deuterium_synthesizer_start'] = "Deuterium Mine Level";
...
$LNG['cs_nanite_factory_start'] = "Nanit Factory Level";
$LNG['cs_shipyard_start'] = "Shipyard Level";
$LNG['cs_metal_storage_start'] = "Metal Storage Level";
$LNG['cs_crystal_storage_start'] = "Crystal Storage Level";
$LNG['cs_deuterium_tank_start'] = "Deuterium Storage Level";
$LNG['cs_research_lab_start'] = "Laboratory Level";
...
$LNG['cs_missile_silo_start'] = "Missile Silo Level";
$LNG['cs_small_cargo_start'] = "Small Ship Cargo (amount)";
$LNG['cs_big_cargo_start'] = "Big Ship Cargo (amount)";
$LNG['cs_light_hunter_start'] = "Light Hunter (amount)";
$LNG['cs_heavy_hunter_start'] = "Heavy Hunter (amount)";
$LNG['cs_cruiser_start'] = "Cruiser (amount)";
$LNG['cs_battle_ship_start'] = "Battle Ship (amount)";
$LNG['cs_colony_ship_start'] = "Colony Ship (amount)";
$LNG['cs_recycler_start'] = "Recycler (amount)";
$LNG['cs_espionage_probe_start'] = "Espionage probe (amount)";
$LNG['cs_bomber_ship_start'] = "Bomber Ship (amount)";
$LNG['cs_solar_satellite_start'] = "Solar Satellite (amount)";
$LNG['cs_destroyer_start'] = "Destroyer (amount)";
$LNG['cs_death_star_start'] = "Death Star (amount)";
...
$LNG['cs_rocket_launcher_start'] = "Misil Launcher (amount)";
$LNG['cs_light_laser_start'] = "Small Laser (amount)";
$LNG['cs_heavy_laser_start'] = "Big Laser (amount)";
$LNG['cs_gauss_cannon_start'] = "Gauss Cannon (amount)";
$LNG['cs_ion_cannon_start'] = "Ion Cannon (amount)";
...
//---------------	Pagina Inicial	------------------------//
$LNG['ow_title'] = 'Steemnova 1.8 X - Space Strategy Game';
...
$LNG['se_expedition_speed'] = 'Expedition speed';
$LNG['se_forum_link'] = 'Forum Link';
$LNG['se_server_op_close'] = 'Is the game closed ?';
...
$LNG['se_planets_officers'] = 'Maximum number of additional planet by officers';
$LNG['se_planets_officers_info'] = 'Per level of the officer, the user should have a new amount of planets to colonize';
...
$LNG['mu_verify'] = 'Check Game content';
...
$LNG['ac_officers_research'] = 'Research';
...
$LNG['ac_urlnow'] = 'URL:';
$LNG['ac_time_destroyed'] = 'Date of total destruction';
$LNG['ac_is_not_destroyed'] = '<font color=red>(Does not exist any planet destroyed recently)</font>';
...
$LNG['modul_40'] = 'Fleets Missile';
$LNG['modul_41'] = 'Fleet Shortcuts';
$LNG['modul_42'] = 'Mission - ACS';
$LNG['modul_43'] = 'Discord';
$LNG['modul_44'] = 'Mission - TRADE';
$LNG['modul_45'] = 'Forum';
$LNG['modul_46'] = 'Mission - TRANSFER';
$LNG['modul_47'] = 'Server Info';
$LNG['modul_48'] = 'Attack Alert';
$LNG['modul_49'] = 'Relocate';
$LNG['modul_50'] = 'Auto Expedition';
