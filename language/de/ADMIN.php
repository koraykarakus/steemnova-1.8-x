...
$LNG['rf_title'] = "RapidFire Einstellungen";
$LNG['rf_rapidfire_rules'] = "Rapidfire Regeln";
$LNG['rf_add_new_rapidfire_rule'] = "Neue Rapidfire Regel hinzufügen";
$LNG['rf_turn_back_to_default'] = "Auf Standardeinstellungen zurücksetzen";
$LNG['rf_against'] = "Gegen";
$LNG['rf_shoots'] = "Schießt";
$LNG['rf_action'] = "Aktion";
$LNG['rf_modify'] = "Bearbeiten";
$LNG['rf_add_new_rule'] = "Neue Regel hinzufügen";
$LNG['rf_from'] = "Von";
$LNG['rf_to'] = "Nach";
$LNG['rf_shoots'] = "Schießt";
$LNG['rf_save'] = "Speichern";
$LNG['rf_err_update_1'] = "Eingaben sind leer oder falsche element_id";
$LNG['rf_err_remove_1'] = "Falsche Eingabe";
$LNG['rf_err_add_1'] = "Fehlende Formulardaten, Eingaben prüfen";
$LNG['rf_err_add_2'] = "Diese Regel existiert bereits, zum Ändern bearbeiten";
$LNG['rf_suc_add'] = "Erfolgreich hinzugefügt";

// ShowGameSettingsPage, buildings settings
$LNG['gsb_title'] = "Gebäudeeinstellungen";
$LNG['gsb_settings'] = "Einstellungen";
$LNG['gsb_add_new_building'] = "Neues Gebäude hinzufügen";
$LNG['gsb_default_settings'] = "Standardeinstellungen [Gebäude]";
$LNG['gsb_cost_grow_factor'] = "Kostensteigerungsfaktor";
$LNG['gsb_base_cost_metal'] = "Grundkosten Metall";
$LNG['gsb_base_cost_crystal'] = "Grundkosten Kristall";
$LNG['gsb_base_cost_deu'] = "Grundkosten Deuterium";
$LNG['gsb_base_cost_energy'] = "Grundkosten Energie";
$LNG['gsb_base_cost_dm'] = "Grundkosten DM";
$LNG['gsb_modify'] = "Ändern";

// auth google
$LNG['google_auth_settings'] = "Google Auth Verbindungseinstellungen";
$LNG['google_auth_info'] = "Diese Funktion kann auf der Modulseite aktiviert/deaktiviert werden.\n
Registrieren Sie sich in der Google API Console und holen Sie sich Ihre Client- und Secret-IDs von Google.\n
Legen Sie Ihre Callback-URL korrekt in der Google API Console fest,\n die Seite sollte immer googleAuth sein und der Modus sollte immer callback sein.\n
Ihre Callback-URLs aus der API Console müssen mit der Callback-URL dieses Formulars übereinstimmen.\n
Verwenden Sie https, wenn Sie SSL haben.";
$LNG['google_auth_client_id'] = "Client-ID:";
$LNG['google_auth_client_secret'] = "Client-Secret:";
$LNG['google_auth_callback_url'] = "Callback-URL [ vollständiger Link ]";

// DISCORD Auth admin panel
$LNG['discord_auth_settings'] = "Discord-Auth Verbindungseinstellungen";

$LNG['discord_auth_info'] = "Diese Funktion kann auf der Modulseite aktiviert/deaktiviert werden.\n
Registrieren Sie sich im Discord Developer Portal, erstellen Sie eine Anwendung und erhalten Sie Ihre Client ID + Client Secret.\n
Legen Sie Ihre Callback-URI korrekt in den Discord OAuth2-Einstellungen fest,\n die Seite muss immer discordAuth sein und der Modus immer callback.\n
z.B.: [ http://localhost/index.php?page=discordAuth&mode=callback ] \n
Ihre Callback-URI im Developer Portal muss exakt mit der Callback-URL dieses Formulars übereinstimmen.\n
Die Auswahl des Scopes als email ist im Discord Developer Portal ausreichend.\n
Verwenden Sie https, wenn SSL aktiviert ist.";

$LNG['discord_auth_client_id'] = "Client-ID:";
$LNG['discord_auth_client_secret'] = "Client-Secret:";
$LNG['discord_auth_redirect_url'] = "Redirect-URL [ vollständiger Link ]";
$LNG['discord_auth_callback_url'] = "Callback-URL [ vollständiger Link ] [z.B.: http://localhost/index.php?page=discordAuth&mode=callback]";
...
$LNG['cs_metal_mine_start'] = "Metallmine Stufe";
$LNG['cs_crystal_mine_start'] = "Kristallmine Stufe";
$LNG['cs_deuterium_synthesizer_start'] = "Deuteriummine Stufe";
$LNG['cs_solar_plant_start'] = "Solarkraftwerk Stufe";
$LNG['cs_fusion_plant_start'] = "Fusionskraftwerk Stufe";
$LNG['cs_robot_factory_start'] = "Roboterfabrik Stufe";
$LNG['cs_nanite_factory_start'] = "Nanitenfabrik Stufe";
$LNG['cs_shipyard_start'] = "Raumschiffswerft Stufe";
$LNG['cs_metal_storage_start'] = "Metallspeicher Stufe";
$LNG['cs_crystal_storage_start'] = "Kristallspeicher Stufe";
$LNG['cs_deuterium_tank_start'] = "Deuteriumspeicher Stufe";
$LNG['cs_research_lab_start'] = "Labor Stufe";
$LNG['cs_terraformer_start'] = "Terraformer Stufe";
$LNG['cs_university_start'] = "Universität Stufe";
$LNG['cs_ally_deposit_start'] = "Allianzdepot Stufe";
$LNG['cs_missile_silo_start'] = "Raketensilo Stufe";
$LNG['cs_small_cargo_start'] = "Kleines Frachtschiff (Menge)";
$LNG['cs_big_cargo_start'] = "Großes Frachtschiff (Menge)";
$LNG['cs_light_hunter_start'] = "Leichter Jäger (Menge)";
$LNG['cs_heavy_hunter_start'] = "Schwerer Jäger (Menge)";
$LNG['cs_cruiser_start'] = "Kreuzer (Menge)";
$LNG['cs_battle_ship_start'] = "Schlachtschiff (Menge)";
$LNG['cs_colony_ship_start'] = "Kolonieschiff (Menge)";
$LNG['cs_recycler_start'] = "Recycler (Menge)";
$LNG['cs_espionage_probe_start'] = "Spionagesonde (Menge)";
$LNG['cs_bomber_ship_start'] = "Bomber (Menge)";
$LNG['cs_solar_satellite_start'] = "Solarsatellit (Menge)";
$LNG['cs_destroyer_start'] = "Zerstörer (Menge)";
$LNG['cs_death_star_start'] = "Todesstern (Menge)";
$LNG['cs_ev_transporter_start'] = "EV Transporter (Menge)";
$LNG['cs_star_crasher_start'] = "Sternenzerstörer (Menge)";
$LNG['cs_dm_ship_start'] = "DM Schiff (Menge)";
$LNG['cs_orbital_station_start'] = "Orbitalstation (Menge)";
$LNG['cs_rocket_launcher_start'] = "Raketenwerfer (Menge)";
$LNG['cs_light_laser_start'] = "Kleiner Laser (Menge)";
$LNG['cs_heavy_laser_start'] = "Großer Laser (Menge)";
$LNG['cs_gauss_cannon_start'] = "Gausskanone (Menge)";
$LNG['cs_ion_cannon_start'] = "Ionenkanone (Menge)";
$LNG['cs_plasma_turret_start'] = "Busterkanone (Menge)";
...
$LNG['ad_editor_officers'] = 'Offiziere';
...
$LNG['ow_title'] = 'Steemnova 1.8 X - Weltraum-Strategiespiel';
...
$LNG['se_expedition_speed'] = 'Expedition-Factor';
$LNG['se_energy_speed'] = 'Energie-Factor';
$LNG['se_forum_link'] = 'Forum link';
$LNG['se_server_op_close'] = 'Ist das Spiel geschlossen?';
...
$LNG['se_planets_officers'] = 'Max. zusätzliche Planetenzahl durch Offiziere';
$LNG['se_planets_officers_info'] = 'Maximaler Bonus an Planeten durch Offiziere. (0 = deaktiviert Limit)';
...
$LNG['se_show_not_learned_ships'] = "Schiffe anzeigen, die noch nicht erforscht wurden";
$LNG['se_show_not_learned_buildings'] = "Gebäude anzeigen, die noch nicht erforscht wurden";
$LNG['se_show_not_learned_tech'] = "Technologien anzeigen, die noch nicht erforscht wurden";
$LNG['se_show_tech_without_research_center'] = "Technologien anzeigen, bevor das Forschungszentrum gebaut wurde";
$LNG['se_show_ships_without_shipyard'] = "Schiffe anzeigen, bevor die Werft gebaut wurde";
...
$LNG['mu_verify'] = 'Verify Game Content';
...
$LNG['ac_officers_research'] = 'Forschung und Offiziere';
...
$LNG['ac_urlnow'] = 'URL: ';
$LNG['ac_time_destroyed'] = 'Datum der Zerstörung';
$LNG['ac_is_not_destroyed'] = '<font color=red>(Bisher wurden keine Monde zerstört)</font>';
