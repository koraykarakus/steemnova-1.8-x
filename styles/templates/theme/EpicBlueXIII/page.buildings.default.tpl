...
<div class="planeto">
	<button id="btn1">Mining</button> | <button id="btn2">Other</button> | <button id="btn3">All</button>
</div>
	...
	<div class="infos_right">
		...
		<div class="infos_right_bottom">
			<div class="infos_inner_left">
				...
				<a href='#' onclick="return Dialog.info({$ResType});" class='tooltip' data-tooltip-content="<table><tr><th>{$LNG.tech.{$ResType}}</th></tr><tr><table class='hoverinfo'><tr><td>{$LNG.shortDescription.$ResType}</td></tr></table></tr></table>">{$LNG.tech.{$ResType}}&nbsp;:&nbsp;{$ResCount|number}</a>
				{/foreach}
				<span>
...
<div class="infos">
	...
	<div class="infos_right">
		<div class="infos_right_top">
			<a href="#" onclick="return Dialog.info({$ID})">{$LNG.tech.{$ID}}</a>
			<span class="yellow">{if $Element.level > 0} ({$LNG.bd_lvl} {$Element.level}{if $Element.maxLevel != 255}/{$Element.maxLevel}{/if}){/if}</span>
		</div>
		<div class="infos_right_bottom">
			<div class="infos_inner_left">
				<span>
