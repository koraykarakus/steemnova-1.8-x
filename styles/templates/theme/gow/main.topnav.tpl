<div style="height:30px;" class="d-flex align-items-center justify-content-center bg-light-black">
  ...
  <ul class="d-flex justify-content-center align-items-center list-unstyled fs-12 py-3 my-0 mx-0 col-4">
    ...
    {if isModuleAvailable($smarty.const.MODULE_NOTICE)}
      <li class="px-2 f-12 hover-underline d-flex align-items-center h-100">
        <a class="text-white" href="javascript:OpenPopup('?page=notes', 'notes', 720, 300);" data-bs-toggle="tooltip"
          data-bs-placement="bottom" data-bs-html="true" title="{$LNG.lm_notes}">
    ...
    {if isModuleAvailable($smarty.const.MODULE_BUDDYLIST)}
      <li class="px-2 f-12 hover-underline d-flex align-items-center h-100">
        <a class="text-white" href="game.php?page=buddyList" data-bs-toggle="tooltip" data-bs-placement="bottom"
    ...
    {/if}
    <li class="px-2 f-12 hover-underline d-flex align-items-center h-100">
      <a class="text-white" href="game.php?page=settings" data-bs-toggle="tooltip" data-bs-placement="bottom"
    ...
    {if isModuleAvailable($smarty.const.MODULE_MESSAGES)}
      ...
      <li class="px-2 f-12 hover-underline d-flex align-items-center h-100">
        <a class="text-white d-flex align-items-center text-decoration-none fs-12 m-0" href="?page=messages"
          data-bs-toggle="tooltip" data-bs-placement="bottom" data-bs-html="true" title="{$LNG.lm_messages}">
    ...
    {if isModuleAvailable($smarty.const.MODULE_STATISTICS)}
      <li class="px-2 f-12 hover-underline d-flex align-items-center h-100">
        <a class="text-white" href="game.php?page=statistics" data-bs-toggle="tooltip" data-bs-placement="bottom"
    ...
    {if isModuleAvailable($smarty.const.MODULE_SEARCH)}
      <li class="px-2 f-12 hover-underline d-flex align-items-center h-100">
        <a class="text-white" href="game.php?page=search" data-bs-toggle="tooltip" data-bs-placement="bottom"
    ...
    {if isModuleAvailable($smarty.const.MODULE_SUPPORT)}
      <li class="px-2 f-12 hover-underline d-flex align-items-center h-100">
        <a class="text-white" href="game.php?page=ticket" data-bs-toggle="tooltip" data-bs-placement="bottom"
    ...
    {/if}
    <li class="px-2 f-12 hover-underline d-flex align-items-center h-100">
      <a class="text-white" href="game.php?page=logout" data-bs-toggle="tooltip" data-bs-placement="bottom"
...
<div class="topnavWrapper d-flex align-items-center mx-auto my-2">
  <div class="d-flex flex-wrap col-5 justify-content-start align-items-end p-0">
    {foreach $resourceTable as $resourceID => $resourceData}
      {if $resourceData@iteration == 5}
      </div>
      <div class="centered-image">
        <a href="game.php?page=overview">
          <img class="" src="styles/resource/images/meta.png" />
        </a>
      </div>
      <div class="d-flex flex-wrap col-5 justify-content-end align-items-start p-0">
      {/if}
          ...
          <div class="d-flex flex-column w-50">
            ...
            <div>
              {if !isset($resourceData.current)}
                ...
                <div
                  class="res_current user-select-none fs-10 {if $resourceData.currentt > 0}color-green{else}color-red{/if}">
                  {$resourceData.currentt|number}
                </div>
              {else}
                <div class="res_current user-select-none fs-10" id="current_{$resourceData.name}"
                  data-real="{$resourceData.current}">{$resourceData.current|number}</div>
              {/if}
            </div>
          </div>
        </div>
    ...
    <div class="resourceWrapperOuter d-flex">
      ...
      <div
        class="resourceWrapper user-select-none d-flex align-items-center justify-content-center fs-10 text-white w-100 h-100">
    ...
    <div class="resourceWrapperOuter user-select-none d-flex">
      <div
        class="resourceWrapper servertime d-flex align-items-center justify-content-center fs-10 text-white w-100 h-100">
        {$servertime}
      </div>
    </div>
  </div>
