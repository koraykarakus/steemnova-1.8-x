...
<form name="message" id="message" action="">
	<table style="width:95%;" class="table table-gow table-sm">
		<tr>
		...
		<tr>
			...
			<td style="width:70%">
				<textarea class="text-white" name="text" id="text" cols="40" rows="10" onkeyup="$('#cntChars').text($(this).val().length);"></textarea>
			</td>
		</tr>
		<tr>
