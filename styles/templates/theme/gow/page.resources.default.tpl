		...
		<table class="table-gow table_full">
			...
			<tbody>
				<tr>
					<td>&nbsp;</td>
					<td>
						<a class="resource_title" href='#' onclick='return Dialog.info(901);'>
							{$LNG.tech.901}
						</a>
					</td>
					<td>
						<a class="resource_title" href='#' onclick='return Dialog.info(902);'>
							{$LNG.tech.902}
						</a>
					</td>
					<td>
						<a class="resource_title" href='#' onclick='return Dialog.info(903);'>
							{$LNG.tech.903}
						</a>
					</td>
					<td>
						<a class="resource_title" href='#' onclick='return Dialog.info(911);'>
							{$LNG.tech.911}
						</a>
					</td>
				</tr>
