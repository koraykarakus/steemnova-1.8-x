...
{block name="content"}
				...
				success: function(data) {
					...
					if (dataParsed.status == 'fail') {
						...
						$('#registerButton').before("<span class='alert alert-success fs-6 py-1 my-1'>" +
							dataParsed.successMessage + "</span>")
	...
	<form style="max-width:500px;" class="form-group mx-auto my-sm-5 d-flex flex-column px-3 rounded bg-transparent-blue"
		...
		<div class="form-group d-flex flex-md-row flex-column justify-content-md-between align-items-center my-2">
			...
			<span class="inputDesc">{$register_password_desc}</span>
		</div>
		<div class="form-group d-flex flex-md-row flex-column justify-content-md-between align-items-center my-2">
		...
		<div class="form-group d-flex flex-row justify-content-md-start align-items-center my-2">
			...
			{/if}
			<span class="fs-6 px-2">{$register_rules_desc}</span>
		</div>
