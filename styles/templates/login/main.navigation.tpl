		...
		{if count($languages) > 1}
			...
			<div class="dropdown">
				<button style="width:120px;height:24px;"
					class="btn btn-secondary dropdown-toggle p-1 d-flex align-items-center justify-content-center"
	...
	<div class="offcanvas offcanvas-start" id="phoneMenu">
		...
		<div class="offcanvas-body p-0 bg-dark">
			...
			<ul style="list-style:none;" class="p-0 m-0 bg-dark p-0 m-0">
				<li class="d-flex align-items-center">
					<a class="fs-6 w-100 hover-color-yellow text-decoration-none py-2 border-light {if $page == 'index'}active{/if}"
						href="index.php?page=index">{$LNG.siteTitleIndex}</a>
				</li>
				<li class="d-flex align-items-center">
					<a class="fs-6 w-100 hover-color-yellow text-decoration-none py-2 border-light {if $page == 'news'}active{/if}"
						href="index.php?page=news">{$LNG.siteTitleNews}</a>
				</li>
				<li class="d-flex align-items-center">
					<a class="fs-6 w-100 hover-color-yellow text-decoration-none py-2 border-light {if $page == 'screens'}active{/if}"
						href="index.php?page=screens">{$LNG.siteTitleScreens}</a>
				</li>
				<li class="d-flex align-items-center">
					<a class="fs-6 w-100 hover-color-yellow text-decoration-none py-2 border-light {if $page == 'banList'}active{/if}"
						href="index.php?page=banList">{$LNG.siteTitleBanList}</a>
				</li>
				<li class="d-flex align-items-center">
					<a class="fs-6 w-100 hover-color-yellow text-decoration-none py-2 border-light {if $page == 'battleHall'}active{/if}"
						href="index.php?page=battleHall">{$LNG.siteTitleBattleHall}</a>
				</li>
				<li class="d-flex align-items-center">
					<a class="fs-6 w-100 hover-color-yellow text-decoration-none py-2 border-light {if $page == 'rules'}active{/if}"
						href="index.php?page=rules">{$LNG.siteTitleRules}</a>
				</li>
				<li class="d-flex align-items-center">
