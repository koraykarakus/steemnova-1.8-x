...
<html lang="{$lang}" class="no-js">
	...
	<head>
		...
		<meta name="description"
			content="Massively Multiplayer Online Strategy Game (MMOSG) for Steemians. Space Browsergame with competition between Alliances for Steem cryptocurrency. Free-to-play, win-to-pay style.">
		<!-- open graph protocol -->
