			...
			<table class="req border">
				<tr>
					<td class="transparent left">
						<p>{$LNG.req_php_need}</p>
						<p class="desc">{$LNG.req_php_need_desc}</p>
					</td>
					<td class="transparent">{$PHP}</td>
				</tr>
				<tr>
					<td class="transparent left">
						<p>{$LNG.reg_global_need}</p>
						<p class="desc">{$LNG.reg_global_desc}</p>
					</td>
					<td class="transparent">{$global}</th>
				</tr>
				<tr>
					<td class="transparent left">
						<p>{$LNG.reg_pdo_active}</p>
						<p class="desc">{$LNG.reg_pdo_desc}</p>
					</td>
				...
				<tr>
					<td class="transparent left">
						<p>{$LNG.reg_gd_need}</p>
						<p class="desc">{$LNG.reg_gd_desc}</p>
					</td>
					<td class="transparent">{$gdlib}</td>
				</tr>
				<tr>
					<td class="transparent left">
						<p>{$LNG.reg_json_need}</p>
					</td>
					<td class="transparent">{$json}</td>
				</tr>
				<tr>
					<td class="transparent left">
						<p>{$LNG.reg_iniset_need}</p>
					</td>
			...
			<td>
				<form name="ftp" id="ftp" action="" onsubmit="return false;">
					<table class="req">
						...
						<tr class="noborder">
							<td class="transparent right" colspan="2"><input type="button" value="{$LNG.req_ftp_send}"
