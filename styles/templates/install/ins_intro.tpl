	...
	<tr>
		<td colspan="2">
			<div id="lang" class="d-flex justify-content-between align-items-center">
				...
				<select style="width:150px;" class="form-select bg-dark text-white text-start py-0" id="lang" name="lang"
			...
			<a class="d-flex w-100 btn btn-primary text-white justify-content-center p-1 my-2"
