{block name="content"}
	<tr>
		<td class="left">
			...
			<p>{$LNG.step4_desc}</p>
			<form action="index.php?page=install&step=8" method="post">
				<input type="hidden" name="post" value="1">
				<table class="req">
					<tr>
						<td class="transparent left">
							<p>{$LNG.step4_admin_name}</p>
							<p class="desc">{$LNG.step4_admin_name_desc}</p>
						</td>
						<td class="transparent"><input type="text" name="username" value="{$name}" size="30"></td>
					</tr>
					<tr>
						<td class="transparent left">
							<p>{$LNG.step4_admin_pass}</p>
							<p class="desc">{$LNG.step4_admin_pass_desc}</p>
						</td>
						<td class="transparent"><input type="password" name="password" value="{$password}" size="30"></td>
					</tr>
					<tr>
						<td class="transparent left">
							<p>{$LNG.step4_admin_mail}</p>
						</td>
