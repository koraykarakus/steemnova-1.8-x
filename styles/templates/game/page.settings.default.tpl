		...
		<table class="table-gow table_full">
			<tbody>
				...
				<tr>
					...
					<td class="text-center"><input name="queueMessages" type="checkbox" value="1"
							{if $queueMessages == 1}checked="checked" {/if}></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td class="text-center"><input name="blockPM" type="checkbox" value="1"
							{if $blockPM == 1}checked="checked" {/if}></td>
				</tr>
				<tr>
