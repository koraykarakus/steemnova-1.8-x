	...
	<form name="message" id="message" action="">
		<table class="table_game">
			...
			<tr>
				...
				<td style="width:70%">
					<input type="text" name="subject" id="subject" size="40" maxlength="40"
						value="{if !empty($subject)}{$subject}{else}{$LNG.mg_no_subject}{/if}">
				</td>
			</tr>
			<tr>
				<td style="width:30%">{$LNG.mg_message}<br>(<span
						id="cntChars">0</span>&nbsp;/&nbsp;5.000&nbsp;{$LNG.mg_characters})</th>
				<td style="width:70%">
			...
			<tr>
				<td colspan="2">
					<input id="submit" type="button" onClick="check();" name="button" value="{$LNG.mg_send}">
				</td>
			</tr>
		</table>
	</form>
