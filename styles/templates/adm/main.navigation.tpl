...
<div id="leftmenu">
  ...
  <ul class="bg-dark d-flex flex-column p-0 m-0" id="menu">
    ...
    {if allowedTo('ShowGoogleAuthPage')}
      <li class="d-flex {if $currentPage == 'googleAuth'}menu-active{/if}">
        <a class="d-flex w-100 h-100 p-1 text-decoration-none text-white fs-6"
          href="?page=googleAuth">{$LNG.mu_google_options}</a>
      </li>
    {/if}
    {if allowedTo('ShowDiscordAuthPage')}
      <li class="d-flex {if $currentPage == 'discordAuth'}menu-active{/if}">
        <a class="d-flex w-100 h-100 p-1 text-decoration-none text-white fs-6"
    ...
    {if allowedTo('ShowStatUpdatePage')}
      <li class="d-flex {if $currentPage == 'statsUpdate'}menu-active{/if}">
        <a class="d-flex w-100 h-100 p-1  text-decoration-none text-white fs-6" href="?page=statsUpdate"
