...
<div id="leftmenu">
  ...
  <ul class="bg-dark d-flex flex-column p-0 m-0" id="menu">
    ...
    {/if}
     {if allowedTo('ShowImprovedGameSettingsPage')}
      <li class="d-flex {if $page == 'improvedGameSettings'}menu-active{/if}">
        <a class="d-flex w-100 h-100 p-1 text-decoration-none fs-6" href="?page=improvedGameSettings">{$LNG.mu_improved_game_settings}</a>
      </li>
    {/if}
