...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="game_name" class="user-select-none my-1 cursor-pointer hover-underline">{$LNG.se_game_name}</label>
	<input id="game_name" class="form-control bg-dark text-white border-secondary" name="game_name" value="{$game_name}" type="text" >
</div>

<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="ttf_file" class="user-select-none my-1 cursor-pointer hover-underline">{$LNG.se_ttf_file}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="timezone" class="my-1 cursor-pointer hover-underline user-select-none">{$LNG.se_timzone}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="theme" class="my-1 cursor-pointer hover-underline user-select-none">Default Theme</label>
...
<div class="form-gorup d-flex my-1 p-2 ">
	<label for="let_users_change_theme" class="my-1 cursor-pointer hover-underline user-select-none">Let users change their theme</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="password_recover_type" class="my-1 cursor-pointer hover-underline user-select-none">Password recovery type</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="del_user_manually" class="my-1 cursor-pointer hover-underline user-select-none">{$LNG.se_del_user_manually}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="del_user_automatic" class="my-1 cursor-pointer hover-underline user-select-none">{$LNG.se_del_user_automatic}</label>
...
<div class="form-gorup d-flex my-1 p-2 ">
	<label for="sendmail_inactive" class="my-1 cursor-pointer hover-underline user-select-none">{$LNG.se_sendmail_inactive}</label>
	<input id="sendmail_inactive" class="mx-2" name="sendmail_inactive"{if $sendmail_inactive} checked="checked"{/if}  type="checkbox">
</div>
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="del_user_sendmail" class="my-1 cursor-pointer hover-underline">{$LNG.se_del_user_sendmail}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="cappublic" class="my-1 cursor-pointer hover-underline">{$LNG.se_recaptcha_public}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="capprivate" class="my-1 cursor-pointer hover-underline">{$LNG.se_recaptcha_private}</label>
...
<div class="form-gorup d-flex my-1 p-2 ">
	<label for="use_recaptcha_on_login" class="my-1 cursor-pointer hover-underline">Recaptcha active on login</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="mail_use" class="my-1 cursor-pointer hover-underline">{$LNG.se_mail_use}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="smtp_sendmail" class="my-1 cursor-pointer hover-underline">{$LNG.se_smtp_sendmail}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="smail_path" class="my-1 cursor-pointer hover-underline">{$LNG.se_smail_path}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="smtp_host" class="my-1 cursor-pointer hover-underline">{$LNG.se_smtp_host}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="smtp_ssl" class="my-1 cursor-pointer hover-underline">{$LNG.se_smtp_ssl}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="smtp_port" class="my-1 cursor-pointer hover-underline">{$LNG.se_smtp_port}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="smtp_user" class="my-1 cursor-pointer hover-underline">{$LNG.se_smtp_user}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="smtp_pass" class="my-1 cursor-pointer hover-underline">{$LNG.se_smtp_pass}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="message_delete_days" class="my-1 cursor-pointer hover-underline">{$LNG.se_message_delete_days}</label>
...
<div class="form-gorup d-flex flex-column my-1 p-2 ">
	<label for="ga_key" class="my-1 cursor-pointer hover-underline">{$LNG.se_google_key}</label>
