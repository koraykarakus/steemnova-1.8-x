{block name="content"}
	...
	<form id="serverSettings" class="bg-black w-75 text-white p-3 my-3 mx-auto fs-12"
		...
		<div class="form-gorup d-flex my-1 p-2 ">
			<label for="let_users_change_theme" class="text-start my-1 cursor-pointer hover-underline user-select-none">Let
				users change their theme</label>
			<input id="let_users_change_theme" class="mx-2" name="let_users_change_theme" {if $let_users_change_theme}
				checked="checked" {/if} type="checkbox">
		</div>
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
			<label for="password_recover_type"
				class="text-start my-1 cursor-pointer hover-underline user-select-none">Password recovery type</label>
		...
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
			...
			<input id="del_user_manually" class="form-control bg-dark text-white border-secondary" name="del_user_manually"
				maxlength="3" size="2" value="{$del_user_manually}" type="text">
		</div>
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
		...
		<div class="form-gorup d-flex my-1 p-2 ">
			<label for="sendmail_inactive"
				class="text-start my-1 cursor-pointer hover-underline user-select-none">{$LNG.se_sendmail_inactive}</label>
			<input id="sendmail_inactive" class="mx-2" name="sendmail_inactive" {if $sendmail_inactive} checked="checked"
				{/if} type="checkbox">
		</div>
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
			<label for="del_user_sendmail"
				class="text-start my-1 cursor-pointer hover-underline">{$LNG.se_del_user_sendmail}</label>
			<input id="del_user_sendmail" class="form-control bg-dark text-white border-secondary" name="del_user_sendmail"
				maxlength="3" size="2" value="{$del_user_sendmail}" type="text">
		</div>
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
		...
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
			...
			<input id="cappublic" class="form-control bg-dark text-white border-secondary" name="cappublic" maxlength="40"
				size="60" value="{$cappublic}" type="text">
		</div>
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
			<label for="capprivate"
				class="text-start my-1 cursor-pointer hover-underline">{$LNG.se_recaptcha_private}</label>
			<input id="capprivate" class="form-control bg-dark text-white border-secondary" name="capprivate" maxlength="40"
				size="60" value="{$capprivate}" type="text">
		</div>
		<div class="form-gorup d-flex my-1 p-2 ">
			<label for="use_recaptcha_on_login" class="text-start my-1 cursor-pointer hover-underline">Recaptcha active on
				login</label>
			<input id="use_recaptcha_on_login" class="mx-2" name="use_recaptcha_on_login" {if $use_recaptcha_on_login}
				checked="checked" {/if} type="checkbox">
		</div>
		<div class="form-gorup d-flex my-1 p-2 ">
			<label for="use_recaptcha_on_register" class="text-start my-1 cursor-pointer hover-underline">Recaptcha active
				on register</label>
			<input id="use_recaptcha_on_register" class="mx-2" name="use_recaptcha_on_register"
				{if $use_recaptcha_on_register} checked="checked" {/if} type="checkbox">
		</div>
		<div class="form-gorup d-flex my-1 p-2 ">
			<label for="use_recaptcha_on_admin_login" class="text-start my-1 cursor-pointer hover-underline">Recaptcha
				active on admin login</label>
			<input id="use_recaptcha_on_admin_login" class="mx-2" name="use_recaptcha_on_admin_login"
				{if $use_recaptcha_on_admin_login} checked="checked" {/if} type="checkbox">
		</div>
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
		...
		<div class="form-gorup d-flex my-1 p-2 ">
			...
			<input id="mail_active" class="mx-2" name="mail_active" {if $mail_active} checked="checked" {/if}
				type="checkbox">
		</div>
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
		...
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
			...
			<input id="smail_path" class="form-control bg-dark text-white border-secondary" name="smail_path" size="20"
				value="{$smail_path}" type="text">
		</div>
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
			<label for="smtp_host" class="text-start my-1 cursor-pointer hover-underline">{$LNG.se_smtp_host}</label>
			<input id="smtp_host" class="form-control bg-dark text-white border-secondary" name="smtp_host" size="20"
				value="{$smtp_host}" type="text" autocomplete="off">
		</div>
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
		...
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
			...
			<input id="smtp_port" class="form-control bg-dark text-white border-secondary" name="smtp_port" size="20"
				value="{$smtp_port}" type="text" autocomplete="off">
		</div>
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
			<label for="smtp_user" class="text-start my-1 cursor-pointer hover-underline">{$LNG.se_smtp_user}</label>
			<input id="smtp_user" class="form-control bg-dark text-white border-secondary" name="smtp_user" size="20"
				value="{$smtp_user}" type="text" autocomplete="new-password">
		</div>
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
			<label for="smtp_pass" class="text-start my-1 cursor-pointer hover-underline">{$LNG.se_smtp_pass}</label>
			<input id="smtp_pass" class="form-control bg-dark text-white border-secondary" name="smtp_pass" size="20"
				value="{$smtp_pass}" type="password" autocomplete="new-password">
		</div>
		<div class="form-gorup d-flex flex-column my-1 p-2 ">
