		...
		<div class="tab-content mt-3">
					...
					<select style="height:200px;" id="timezone" class="form-select bg-dark text-white border-secondary"
						...
						{foreach $Selector.timezone as $field => $currentTimezone}
							{foreach $currentTimezone as $key => $cTimeZone}
								<option class="p-0" value="{$key}" {if $key == $timezone}selected{/if}>{$field} / {$cTimeZone}
								</option>
							{/foreach}
						{/foreach}
					</select>
			...
			<div class="tab-pane fade" id="tab_2">
				...
				<div class="form-gorup d-flex my-1 p-2 ">
					...
					<input id="sendmail_inactive" class="mx-2" name="sendmail_inactive" {if $sendmail_inactive}
			...
			<div class="tab-pane fade" id="tab_3">
				...
				<div class="form-gorup d-flex my-1 p-2 ">
					<label for="use_recaptcha_on_login" class="text-start my-1 cursor-pointer hover-underline">Recaptcha
						active on
						login</label>
					<input id="use_recaptcha_on_login" class="mx-2" name="use_recaptcha_on_login"
						{if $use_recaptcha_on_login} checked="checked" {/if} type="checkbox">
				</div>
				<div class="form-gorup d-flex my-1 p-2 ">
					<label for="use_recaptcha_on_register" class="text-start my-1 cursor-pointer hover-underline">Recaptcha
						active
						on register</label>
				...
				<div class="form-gorup d-flex my-1 p-2 ">
					<label for="use_recaptcha_on_admin_login"
						class="text-start my-1 cursor-pointer hover-underline">Recaptcha
			...
			<div class="tab-pane fade" id="tab_4">
				<div class="form-gorup d-flex my-1 p-2 ">
					<label for="mail_active"
						class="text-start my-1 cursor-pointer hover-underline">{$LNG.se_mail_active}</label>
			...
			<div class="tab-pane fade" id="tab_6">
				<div class="form-gorup d-flex my-1 p-2 ">
					<label for="ga_active"
						class="text-start my-1 cursor-pointer hover-underline">{$LNG.se_google_active}</label>
					<input id="ga_active" class="mx-2" name="ga_active" {if $ga_active} checked="checked" {/if}
						type="checkbox">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
