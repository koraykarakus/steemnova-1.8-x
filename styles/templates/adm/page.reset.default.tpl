{block name="content"}
    <form action="?page=reset&mode=send" method="post" onsubmit="return confirm('{$re_reset_universe_confirmation}');">
        <table class="table table-dark table-striped table-sm fs-12 w-50 my-5 mx-auto">
            <tr>
                <th colspan="2">{$re_player_and_planets}</th>
            </tr>
            <tr>
            ...
            <tr>
                <th colspan="2">{$re_defenses_and_ships}</th>
            </tr>
            <tr>
            ...
            <tr>
                <th style="text-align:left;">{$re_reset_all}</th>
                <th style="text-align:right;margin-right:2px;padding-right:5px;width:10px;"><input type="checkbox"
                        name="resetall" onclick="$('input').attr('checked', this.checked ? 'checked' : false)"></th>
            </tr>


            <tr>
                <td colspan="2" height="60"><input type="submit" value="{$button_submit}"></td>
            </tr>
        </table>
{/block}