{block name="content"}
	...
	<form id="universeSettings" class="bg-black w-75 text-white p-3 my-3 mx-auto fs-12"
		...
		<div class="form-gorup d-flex justify-content-between my-3">
			<input style="max-width:250px;" id="searchInUniverseSettings"
				class="form-control py-1 bg-dark text-white my-1 border border-secondary" type="text" name=""
				placeholder="search..">
		</div>
		...
		<div class="tab-content mt-3">
			<div class="tab-pane fade show active" id="tab_1">
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="uni_name" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<select id="lang" class="form-select py-1 bg-dark text-white my-1 border border-secondary" name="lang">
						{foreach $Selector.langs as $clangshort => $clang}
							<option class="py-1 bg-dark text-white my-1" value="{$clangshort}"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="game_speed" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
						name="game_speed" value="{$game_speed}" type="text" maxlength="5">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="fleet_speed">{$LNG.se_fleet_speed}</label>
					<input id="fleet_speed" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="resource_multiplier"
						class="form-control py-1 bg-dark text-white my-1 border border-secondary" name="resource_multiplier"
						value="{$resource_multiplier}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="storage_multiplier">{$LNG.se_storage_producion_speed}</label>
					<input id="storage_multiplier" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="energySpeed" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="forum_url" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<textarea id="close_reason" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
			...
			<div class="tab-pane fade" id="tab_2">
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="max_elements_build" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="max_elements_tech" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="max_elements_ships" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="max_fleet_per_build"
						class="form-control py-1 bg-dark text-white my-1 border border-secondary" name="max_fleet_per_build"
			...
			<div class="tab-pane fade" id="tab_3">
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="ref_bonus" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
						name="ref_bonus" maxlength="6" size="8" value="{$ref_bonus}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="ref_minpoints">{$LNG.se_ref_minpoints}</label>
					<input id="ref_minpoints" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
						name="ref_minpoints" maxlength="20" size="25" value="{$ref_minpoints}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="ref_max_referals">{$LNG.se_ref_max_referals}</label>
					<input id="ref_max_referals" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
			...
			<div class="tab-pane fade" id="tab_4">
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="min_player_planets" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="planets_tech" name="planets_tech"
						class="form-control py-1 bg-dark text-white my-1 border border-secondary" maxlength="11" size="11"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="planets_per_tech" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
			...
			<div class="tab-pane fade" id="tab_5">
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="darkmatter_start" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="initial_fields" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="metal_basic_income" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
			...
			<div class="tab-pane fade" id="tab_6">
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="min_build_time" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="max_galaxy" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
						name="max_galaxy" maxlength="3" size="3" value="{$max_galaxy}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="max_system">{$LNG.se_max_system}</label>
					<input id="max_system" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
						name="max_system" maxlength="5" size="5" value="{$max_system}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="max_planets">{$LNG.se_max_planets}</label>
					<input id="max_planets" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
						name="max_planets" maxlength="3" size="3" value="{$max_planets}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="planet_factor">{$LNG.se_planet_factor}</label>
					<input id="planet_factor" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
						name="planet_factor" maxlength="3" size="3" value="{$planet_factor}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="max_overflow">{$LNG.se_max_overflow}</label>
					<input id="max_overflow" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
						name="max_overflow" maxlength="3" size="3" value="{$max_overflow}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="moon_factor">{$LNG.se_moon_factor}</label>
					<input id="moon_factor" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
						name="moon_factor" maxlength="3" size="3" value="{$moon_factor}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="moon_chance">{$LNG.se_moon_chance}</label>
					<input id="moon_chance" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="factor_university" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="max_fleets_per_acs" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
						name="max_fleets_per_acs" maxlength="3" size="3" value="{$max_fleets_per_acs}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="silo_factor">{$LNG.se_silo_factor}</label>
					<input id="silo_factor" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
						name="silo_factor" maxlength="2" size="2" value="{$silo_factor}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="vmode_min_time">{$LNG.se_vmode_min_time}</label>
					<input id="vmode_min_time" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
						name="vmode_min_time" maxlength="11" size="11" value="{$vmode_min_time}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="gate_wait_time">{$LNG.se_gate_wait_time}</label>
					<input id="gate_wait_time" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="max_dm_missions" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
				...
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline" for="user_max_notes">User maximum
						notes</label>
					<input id="user_max_notes" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
			...
			<div class="tab-pane fade" id="tab_7">
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					...
					<input id="trade_allowed_ships"
						class="form-control py-1 bg-dark text-white my-1 border border-secondary" name="trade_allowed_ships"
						maxlength="255" size="60" value="{$trade_allowed_ships}" type="text">
				</div>
				<div class="form-gorup d-flex flex-column my-1 p-2 ">
					<label class="text-start my-1 cursor-pointer hover-underline"
						for="trade_charge">{$LNG.se_trader_charge}</label>
					<input id="trade_charge" class="form-control py-1 bg-dark text-white my-1 border border-secondary"
