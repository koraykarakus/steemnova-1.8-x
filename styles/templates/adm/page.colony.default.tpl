{block name="content"}
  ...
  <form id="colonySettings" class="bg-black w-75  p-3 my-3 mx-auto fs-12"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="metal_start" class="form-control py-1 bg-dark  my-1 border border-secondary" name="metal_start"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="crystal_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="deuterium_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="deuterium_start" value="{$deuterium_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="metal_mine_start">{$LNG.cs_metal_mine_start}</label>
      <input id="metal_mine_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="metal_mine_start" value="{$metal_mine_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="crystal_mine_start">{$LNG.cs_crystal_mine_start}</label>
      <input id="crystal_mine_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="deuterium_synthesizer_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="solar_plant_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="fusion_plant_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="robot_factory_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="nanite_factory_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="shipyard_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="shipyard_start" value="{$shipyard_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="metal_storage_start">{$LNG.cs_metal_storage_start}</label>
      <input id="metal_storage_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="crystal_storage_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="deuterium_tank_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="research_lab_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="terraformer_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="terraformer_start" value="{$terraformer_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="university_start">{$LNG.cs_university_start}</label>
      <input id="university_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="university_start" value="{$university_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="ally_deposit_start">{$LNG.cs_ally_deposit_start}</label>
      <input id="ally_deposit_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="missile_silo_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="silo_start" value="{$missile_silo_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="small_cargo_start">{$LNG.cs_small_cargo_start}</label>
      <input id="small_cargo_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="small_cargo_start" value="{$small_cargo_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="big_cargo_start">{$LNG.cs_big_cargo_start}</label>
      <input id="big_cargo_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="big_cargo_start" value="{$big_cargo_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="light_hunter_start">{$LNG.cs_light_hunter_start}</label>
      <input id="light_hunter_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="heavy_hunter_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="cruiser_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="cruiser_start" value="{$cruiser_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="battle_ship_start">{$LNG.cs_battle_ship_start}</label>
      <input id="battle_ship_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="battle_ship_start" value="{$battle_ship_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="colony_ship_start">{$LNG.cs_colony_ship_start}</label>
      <input id="colony_ship_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="recycler_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="espionage_probe_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="bomber_ship_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="solar_satellite_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="destroyer_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="destroyer_start" value="{$destroyer_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="death_star_start">{$LNG.cs_death_star_start}</label>
      <input id="death_star_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="ev_transporter_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="star_crasher_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="dm_ship_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="dm_ship_start" value="{$dm_ship_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="orbital_station_start">{$LNG.cs_orbital_station_start}</label>
      <input id="orbital_station_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
        for="heavy_laser_start">{$LNG.cs_heavy_laser_start}</label>
      <input id="heavy_laser_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
        name="heavy_laser_start" value="{$heavy_laser_start}" type="text" maxlength="5">
    </div>
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      <label class="text-start my-1 cursor-pointer hover-underline"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="small_protection_shield_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="planet_protector_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="big_protection_shield_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="interceptor_misil_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
    ...
    <div class="form-gorup d-flex flex-column my-1 p-2 ">
      ...
      <input id="interplanetary_misil_start" class="form-control py-1 bg-dark  my-1 border border-secondary"
